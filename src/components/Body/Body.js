    ...
    <div id='body-container'>
      <div id='banner-container'>
        <div id='slogan-container'>
          <p id="slogan" > TRUST IN CO-OPERATIVE,</p>
          <p id="slogan" > GROW WITH CO-OPERATIVE </p>
          <p id='under-slogan'>The primary objective of the Society revolves around the cultivation and enhancement of a culture of prudent Savings amongst its </p>
        </div>
        <div id='logo-container'><img src={logo} alt="co-operative" id='coop-img' />
        </div>
      </div>
      <div id="features">
          <h1>FEATURES</h1>
